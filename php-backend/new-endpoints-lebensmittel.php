<?php
// NEW endpoints/lebensmittel.php with Multi-Tenant support
    ...
    try {
        ...
        $result = array_map(function($item) {
            return [
                ...
                'NEW_ENDPOINTS_SUCCESS' => 'MULTI_TENANT_WORKING',
...
function get_lebensmittel_by_id($pdo, $id) {
    try {
        $user = requireAuth();
