<?php
// Working endpoints/lebensmittel.php with correct paths and Multi-Tenant support

// Include dependencies with correct paths (from index.php perspective)
    ...
    try {
        ...
        $result = array_map(function($item) {
            return [
                ...
                'WORKING_ENDPOINTS_SUCCESS' => 'MULTI_TENANT_FIXED',
...
function create_lebensmittel($pdo) {
    try {
        ...
        echo json_encode([
            ...
            'updated_by' => null,
            'WORKING_ENDPOINTS_SUCCESS' => 'MULTI_TENANT_CREATED'
        ]);
